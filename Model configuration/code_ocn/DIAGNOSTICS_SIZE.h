C $Header: /u/gcmpack/MITgcm_contrib/dfer/cpl_aim+ocn_fast/code_ocn/DIAGNOSTICS_SIZE.h,v 1.1 2006/07/06 18:18:34 dfer Exp $
C $Name:  $
...
C  and "diagSt_size" (statistics-diags) since values here are deliberately small.
      ...
      INTEGER    numdiags
      INTEGER    nRegions, nStats, sizRegMsk
      INTEGER    diagSt_size
      PARAMETER( ndiagMax = 500 )
      PARAMETER( numlists = 10, numperlist = 50, numLevels=2*Nr )
      PARAMETER( numdiags = 700*Nr )
      PARAMETER( nRegions = 6 , sizRegMsk = 1 , nStats = 4 )
